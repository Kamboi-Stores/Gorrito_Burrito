...
export default async function Page() {
  ...
  const content = {
    title: homepage?.title || 'Fresh • Local • Fast',
    subtitle: homepage?.subtitle || '',
    description: homepage?.description || 'Find your nearest location and order online.',
    ctaText: homepage?.ctaText || 'Order Online',
    ctaLink: homepage?.ctaLink || '/order',
    heroImage: homepage?.heroImage || null,
    locationTitle: homepage?.locationTitle || 'Find a Location'
  };
